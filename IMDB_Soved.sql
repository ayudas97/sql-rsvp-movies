/*To Fix ERROR: Got a packet bigger than 'max_allowed_packet' bytes*/
...
FROM mIN ratings as r ON m.id=r.movie_id
...
Letovie AS m
INNER JO’s find out the top three directors in the top three genres who can be hired by RSVP Movies.*/
